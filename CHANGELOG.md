...
## [Unreleased](https://github.com/nationalarchives/tna-frontend-jinja/compare/v0.24.0...HEAD)
...
- `BooleanField` with `TnaCheckboxWidget` doesn't render a fieldset and takes the field `desciption` as the checkbox label
